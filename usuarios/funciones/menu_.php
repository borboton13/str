...
<li><span class="ebul_imgcbmenu16x16" style="background-image: url('<?=$menu?>cbsiicbmenu_2.gif')"></span><a href="<?=$repo?>">Repositorio de Proyectos Guardados</a></li>
</ul>
...
<ul id="cbmenuebul_table" class="cbmenuebul_menulist" style="width: 851px; height: 26px;">
