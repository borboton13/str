...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function calConfig() {
		...
		self.maxDate = new Date(2030,12,31);
	...
	*/
	function setLang() {
		...
		self.months_sh = new Array('Ens','Feb','Mar','Abr','May','Jun','Jul','Ago','Sep','Oct','Nov','Dic');
		...
		self.maxrange_caption = 'Ésta es la gawwma máxima';
