...
<body>
    <form class="form" name="form" method="post" action="v0001.php">
        <div class="login-form">
            ...
            <h1>SISTEMA DE <br />SEGUIMIENTO TECNICO</h1>
            ...
            <?php if($sw==1){ ?> <span class="alert">Credenciales Invalidas</span> <?php } ?>
            <?php if($sw==2){ ?> <span class="alert">Error! Su sesi&oacute;nn ha caducado</span> <?php } ?>
            <!--<a class="link" href="#">Lost your password?</a>-->
            <button class="log-btn" type="submit">Iniciar Sesi&oacute;n</button>
            <div align="center" class="texto"><br />&copy; <?=date("Y");?></div>
        </div>
    </form>
