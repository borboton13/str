...
$res_p019v_2 = mysql_query("SELECT * FROM p019v_relevamientoinfraestructura where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysql_fetch_assoc($res_p019v_2)) { 
...
$res_p019v_3 = mysql_query("SELECT * FROM p019v_transportemicroondas where idevento=".$idevento." ORDER BY numero");

while($datatmp = mysql_fetch_assoc($res_p019v_3)) { 
...
$res_p019v_6 = mysql_query("SELECT  
...
while($datatmp = mysql_fetch_assoc($res_p019v_6)) { 
...
$res_p019v_7 = mysql_query("SELECT  p019v_tdisptarjetasequipos.orden,
...
while($datatmp = mysql_fetch_assoc($res_p019v_7)) { 
...
$res_p019v_8 = mysql_query("SELECT * from p019v_relevamientoserviciomovil where idevento=".$idevento." 
ORDER BY numero");


while($datatmp = mysql_fetch_assoc($res_p019v_8)) { 
