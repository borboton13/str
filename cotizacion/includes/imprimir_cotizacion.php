...
<div id="app">
    ...
    <div class="row">
        <img src="img/logo-sertero.jpg" class="img-fluid" alt="Responsive image">
        <br />SERTERO SRL <br />
        SERVICIOS EN TELECOMUNICACIONES <br />
        COTIZACION / <?php echo htmlentities($cotizacion->fecha) ?>
    </div>
    ...
    <div class="row">
        <div class="col-sm">
            <ul class="list-group">
                <li class="list-group-item"><?php echo htmlentities($cotizacion->descripcion) ?></li>
                <li class="list-group-item">CLIENTE: <?php echo htmlentities($cotizacion->razonSocial) ?></li>
            </ul>
        </div>
    </div>
    ...
    <!--<div class="row">
        <div class="col-sm">
            <h3>Cotización: <?php /*echo htmlentities($cotizacion->descripcion) */?></h3>
