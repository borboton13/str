...
<td width="50%"><div align="right" style="padding-right:80px">
  <table width="200">
    <tr>
      ...
      <td <?php if($dato['p5']=="TRANSMISION") { echo'style="background-color:#333333"'; $aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">ENERGIA</div></td>
      <td <?php if($dato['p5']=="ENERGIA") { echo'style="background-color:#333333"'; $aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">RBS</div></td>
      <td <?php if($dato['p5']=="RBS") { echo'style="background-color:#333333"'; $aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">BTS</div></td>
      <td <?php if($dato['p5']=="BTS") { echo'style="background-color:#333333"'; $aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">INFRAESTRUCTURA</div></td>
     <td <?php if($dato['p5']=="INFRAESTRUCTURA") { echo'style="background-color:#333333"'; $aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
  </table>
 </div></td>
<TD width="50%"><div align="right" style="padding-right:80px">
  <table width="200">
    <tr>
      ...
      <td <?php if($dato['p6']=="CORTE DE TRAFICO") { echo'style="background-color:#333333"';$aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">CORTE INTERMITENTE</div></td>
      <td <?php if($dato['p6']=="CORTE INTERMITENTE") { echo'style="background-color:#333333"';$aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right">PELIGRO DE CORTE</div></td>
      <td <?php if($dato['p6']=="PELIGRO DE CORTE") { echo'style="background-color:#333333"';$aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
    <tr>
      <td><div align="right"><? if(substr($dato['p6'],0,5)=="OTROS") { echo $dato['p6'];} else { echo "OTROS"; } ?></div></td>
      <td <?php if(substr($dato['p6'],0,5)=="OTROS") { echo'style="background-color:#333333"';$aspa="X"; } else { $aspa="";}?> class="cuadro">&nbsp;<?=$aspa?>&nbsp;</td>
    </tr>
  </table>
</div></TD>
</tr>
