...
<TABLE width="900" align="center" class="table2">
	...
	<table  width="1000" align="center" class="table2">
		...
		<?
		//$text =	"Verificación del estado de pararrayos.;;;;;;;;;;;|".
		$text =	"Revisión , limpieza , ajuste de conexiones de cables, jabalinas mediante las  cámaras de inspección;;;;;;;;;;;|".
	...
	<br />
		...
		<?
		$text =	"Valor de tierra en la malla ubicada en la base de la torre en Ohms (máximo es 10 Ohm)[Ohm];;|Valor de tierra en el distribuidor de tierra de la malla alrededor de la sala de equipos (máximo es 10 Ohm)[Ohm];;|Medida de Potencial entre el sistema de tierra y neutro[V];;|Medida Potencial entre el neutro y masa[V];;";
		$arrays = explode('|',$text);
		$result = "";
		$a = 1;
		foreach ($arrays as $array){
