        ...
        <td class="marco_">
            ...
            <form name="amper" method="post" action="#">
                ...
                <select name="anio" class="selectbuscar">
                    ...
                    <option value="2023" <?php if($anio==2023) echo"class='naranja' selected"; ?>>2023</option>

                    <option value="2022" <?php if($anio==2022) echo"class='naranja' selected"; ?>>2022</option>

                    <option value="2021" <?php if($anio==2021) echo"class='naranja' selected"; ?>>2021</option>

                    <option value="2020" <?php if($anio==2020) echo"class='naranja' selected"; ?>>2020</option>

                    <option value="2019" <?php if($anio==2019) echo"class='naranja' selected"; ?>>2019</option>

                    <option value="2018" <?php if($anio==2018) echo"class='naranja' selected"; ?>>2018</option>

                    <option value="2017" <?php if($anio==2017) echo"class='naranja' selected"; ?>>2017</option>

                    <option value="2016" <?php if($anio==2016) echo"class='naranja' selected"; ?>>2016</option>
