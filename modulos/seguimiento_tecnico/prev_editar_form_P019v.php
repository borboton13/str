...
$resultado = mysql_query("SELECT * FROM p019v_formulario WHERE idevento = '$idevento' ");
//$totalFilas    =    mysql_num_rows($resultado);  
$datoP019vformulario = mysql_fetch_array($resultado);
...
////////////////////////
$resultado = mysql_query("SELECT * FROM p019v_relevamientoinfraestructura WHERE idevento = $idevento ");
$filasp019v_2=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019v_transportemicroondas WHERE idevento = $idevento ");
$filasp019v_3=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019v_mantenimientopreventivo WHERE idevento = $idevento ");
$filasp019v_6=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019v_disptarjetasequipos WHERE idevento = $idevento ");
$filasp019v_7=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019v_relevamientoserviciomovil WHERE idevento = $idevento ");
$filasp019v_8=mysql_num_rows($resultado);
////////////////////////
