...
$query= mysql_query("SELECT MAX(id) FROM formulario_p002");
$row = mysql_fetch_row($query);
$idm = $idm = trim($row[0]);;

$Hoy = date("Y-m-d H:i:s");
$srr = mysql_query("INSERT INTO p002_formulario VALUES ('$idm','$ideventos','$responsable','$pss10','$pss11','$serenos','$observacion','$fechamantenimiento','$Hoy')");
 }else

  $sql =mysql_query("UPDATE p002_formulario SET responsable = '$responsable', fechamantenimiento = '$fechamantenimiento' WHERE id = '$idformtto'");
