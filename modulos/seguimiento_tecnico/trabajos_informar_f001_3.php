...
<table width="600" align="center">
    ...
    <tr>
        <td>
            <a class="enlaceboton" href="<?=$link_modulo?>?path=trabajos_ver_correlativo.php&nro=<?=$dato['id_st_proyecto']?>" target='_top'>
                <img src='../../img/ico_detalles.gif' alt='Ver Proyecto' border="0" align="absmiddle"> Ver Lista de Equipos del Proyecto
            </a>
        </td>
    </tr>
        ...
        <td>
            <form name="amper" method="post" action="<?=$link_modulo_r?>" onSubmit=" return VerifyOne ();">
                ...
                <table width="100%" class="table2">
                    <caption><span style="font-size:18px">INFORME EMERGENCIAS</span><br />Llenar Formulario Paso 3 de 3:</caption>
                    <tr>
                        <td width="65%">Proyecto Nro:<span class="title"><?=$dato['id_st_proyecto'];?></span></td>
                    ...
                    <tr>
                        <td>Cliente:<span class="medium title7"><?=$cliente;?></span></td>
                        <td width="35%" align="right">Mantenimiento Nro: <strong class="medium"><?=$dato['periodo'];?> de <?=$de?></strong></td>
                    </tr>
                </table>
                ...
                <table width="100%" class="table2">
                    ...
                    <tr>
                        <td>Estaci&oacute;n: <span class="azul"><?=$dato_t['ubicacion'];?></span></td><td>
                            Departamento:<span class="azul"><?=$dato_t['departamento'];?></span></td>
                    </tr>
                </table>
                    ...
                    if($filas!=0) {
                        ...
                        while($dato_arch=mysqli_fetch_array($resultado)) {
                            ...
                            <tr height="25" onmouseover="setPointer(this, '#DADADA')" onmouseout="setPointer(this, '<?=$rowt?>')">
                                ...
                                <TD style="background:<?=$rowt?>"><div align="right"><?php echo round($tam)." Kb"; ?></div></TD>
                ...
                ?>
                            ...
                            <tr>
                                <td height="30">
                                    <table border="0" align="center" class="table2">
                                        <tr>
                                            <td class="marco"><label><input name="condicion_final" type="radio" value="OK">
                                                    ...
                                                    <span class="title2">Irreparable</span></label> &nbsp;
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table width="100%" cellspacing="2" class="table2">
                            ...
                            <tr>
                                <td width="50%"><span class="title6">Tecnico responsable:</span>
                                    <?php
                            ...
                            <tr>
                                <td width="50%"><span class="title6">Destinatarios Cliente:</span>
                                    <?php
                                    ...
                                    if($filas!=0){
                                        while($datoc=mysqli_fetch_array($resultado)){
                                            ?>
                                            <br />
                                            <label id="label<?=$k?>" class="marcar_check">
                                                <input name="notificar[]" type="checkbox" value="<?=$datoc['mail']?>" id="check_<?=$k?>" onclick="marcar_check(this,'label<?=$k?>')" />
                                ...
                                <td>
                                    ...
                                    if($filas!=0){
                                        while($datoc=mysqli_fetch_array($resultado)){
                                            ...
                                            <br />
                                            <label id="label<?=$k?>" class="marcar_check">
                                                <input name="notificar[]" type="checkbox" value="<?=$datoc['mail']?>" id="check_<?=$k?>" onclick="marcar_check(this,'label<?=$k?>')" checked="checked"/>
                                                <?=$datoc['mail']?>  </label>(<?=$datoc['usuario']?>)
                                            <?php
                                            $k++;
                                        }
                            ...
                            <tr>
                                <td height="20">
                                    <div align="center"><input name="validar" type="submit" class="large" value="ENVIAR INFORME" /></div>
                                </td>
                            </tr>
                            </tfoot>
                        </table>
                    ...
                    ?>
                        ...
                        <table width="100%" cellspacing="2" class="table2">
                            ...
                            <tr>
                                <td height="20" class="cafe">Este mensaje no forma parte del Informe, solo es informacion para fines internos:</td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <span class="title6">Enviar Notificacion de Revision a:</span>
                                    <?php
                                    $consulta   = "SELECT CONCAT(nombre,' ',ap_pat) AS usuario,mail FROM usuarios WHERE nivel='1'";
                                    $resultado  = mysqli_query($conexion, $consulta);
                                    $k=1;
                                    ...
                                    ?>
                                            ...
                                            <label id="label<?=$k?>" class="marcar_check">
                                                <input name="notificar[]"
                                                       ...
                                                       value="<?=$datoc['mail']?>"
                                                       id="check_<?=$k?>"
                                                       onclick="marcar_check(this,'label<?=$k?>')"
                                                       checked="checked"/>
                                                <?=$datoc['mail']?>
                                            </label>(<?=$datoc['usuario']?>)
                                            <?php
                            ...
                            <tfoot>
                            <tr>
                                <td height="20"><div align="center"><input name="validar" type="submit" class="large" value="ENVIAR A REVISION" /></div></td>
                            </tr>
                            </tfoot>
                ...
                <table width="600" border="0" align="right" class="table2">
                    <tr><td class="marco"><?php echo " <a class=\"enlaceboton\" href='../../html/html_st_".$pro_key.".php?id_st_cronograma_informes=".base64_encode($id_st_cronograma_informes)."&id_item=".base64_encode($dato['id_item'])."' onClick=\"openNewWindowhtml( this, '800', '590' );return false;\"><img src='../../img/c_html.gif' alt='Ver Informe en HTML' border=\"0\">Vista preliminar en HTML</a>"; ?></td><td class="marco"><?php echo "<a class=\"enlaceboton\" href='../../pdf/pdf_st_".$pro_key.".php?id_st_cronograma_informes=".base64_encode($id_st_cronograma_informes)."&id_item=".base64_encode($dato['id_item'])."' onClick=\"openNewWindowhtml( this, '800', '590' );return false;\"><img src='../../img/imp.gif' alt='Ver Informe en PDF' border=\"0\">Vista Preliminar en PDF</a> ";
                            ?></td><td class="marco"><a class="enlaceboton" href="<?=$link_modulo?>?path=trabajos_informar_<?=$pro_key?>_2.php&id_st_cronograma_informes=<?=$id_st_cronograma_informes?>" target='_top'><img src='../../img/change.gif' alt='Volver al Paso Anterior' border="0" align="absmiddle"> Volver Al Paso Anterior </a>
                        </td>
                    </tr>
                </table>
            </form>
...
<script type="text/javascript">
    function VerifyOne () {
        if(validarRB(document.amper.condicion_final,'Seleccione la condicion final!')) {
            if(confirm("ESTA VALIDANDO ESTE FORMULARIO\n Verificar bien los datos antes de continuar?")) {
                return true;
            } else {
                return false;
            }
