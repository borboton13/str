    ...
    <table width="100%" class="table2">
        ...
        <tr>
            <td colspan="2" align="center">
                <input type="checkbox" name="sa01" value="sa01" <?php if ($dato['sa01']=='1') echo 'checked'; ?>>GSM</input>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="sa02" value="sa02" <?php if ($dato['sa02']=='1') echo 'checked'; ?>>3G</input>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="sa03" value="sa03" <?php if ($dato['sa03']=='1') echo 'checked'; ?>>4G</input>&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="sa04" value="sa04" <?php if ($dato['sa04']=='1') echo 'checked'; ?>>LTE</input>
...
<td width="50%">
    ...
    TRANSMISION <input name="p5" type="radio" value="TRANSMISION" <?php if($dato['p5']=="TRANSMISION") { echo"checked";}?>/><br />
    ENERGIA <input name="p5" type="radio" value="ENERGIA" <?php if($dato['p5']=="ENERGIA") { echo"checked";}?>/><br />
    RBS <input name="p5" type="radio" value="RBS" <?php if($dato['p5']=="RBS") { echo"checked";}?>/><br />
    BTS <input name="p5" type="radio" value="BTS" <?php if($dato['p5']=="BTS") { echo"checked";}?>/><br />
    INFRAESTRUCTURA<input name="p5" type="radio" value="INFRAESTRUCTURA" <?php if($dato['p5']=="INFRAESTRUCTURA") { echo"checked";}?>/>
    </div>
</td>
<TD width="50%">
    <div align="right" style="padding-right:80px">
    CORTE DE TRAFICO <input name="p6" type="radio" value="CORTE DE TRAFICO"  <?php if($dato['p6']=="CORTE DE TRAFICO") { echo"checked";}?>/><br />
    CORTE INTERMITENTE <input name="p6" type="radio" value="CORTE INTERMITENTE" <?php if($dato['p6']=="CORTE INTERMITENTE") { echo"checked";}?>/><br />
    PELIGRO DE CORTE <input name="p6" type="radio" value="PELIGRO DE CORTE" <?php if($dato['p6']=="PELIGRO DE CORTE") { echo"checked";}?>/></div><div align="center">
    OTROS <input name="p6" type="radio" value="OTROS" <?php if(substr($dato['p6'],0,5)=="OTROS") { echo"checked";}?>/>
    <input name="p6_otros" type="text" <?php if(substr($dato['p6'],0,5)=="OTROS") { echo"value='".substr($dato['p6'],7)."'";}?>/>
    </div></TD>
</tr>
<tr>
