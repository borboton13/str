...
<tr>
    ...
    <th width="30"><div align="center">Cuadrilla</div></th>
    <th width="10%"><div align="center">Usr</div></th>
    <th width="15%"><div align="center">Ingresos</div></th>
    <th width="15%"><div align="center">Egresos</div></th>
</tr>
<?php
/*
...
$consulta = "   SELECT p.declaracion_proyecto, i.id_usuario, CONCAT(u.nombre, ' ', u.ap_pat) AS cuadrilla, SUM(IF(t.tipo= 'I', t.importe, 0)) AS ingresos, SUM(IF(t.tipo= 'E', t.importe, 0)) AS egresos
                FROM transaccion t 
                LEFT JOIN st_trabajos tr ON t.id_item = tr.id_item 
                LEFT JOIN st_proyecto p  ON tr.id_st_proyecto = p.id_st_proyecto
...
if($filas!=0){ 
    ...
    while($dato=mysqli_fetch_array($resultado)){
        ...
        <tr>
            ...
            <td class="marco" align="center"><?=$cuadrilla;?></td>
            <td class="marco" align="center"><?=$id_usuario;?></td>
