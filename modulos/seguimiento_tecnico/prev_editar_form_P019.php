...
$datoP019formulario = mysql_fetch_array($resultado);
...
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_relevamientoinfraestructura WHERE idevento = $idevento ");
$filasp019_2=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_transportemicroondas WHERE idevento = $idevento ");
$filasp019_3=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_transportefibra WHERE idevento = $idevento ");
$filasp019_4=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_transportesatelital WHERE idevento = $idevento ");
$filasp019_5=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_mantenimientopreventivo WHERE idevento = $idevento ");
$filasp019_6=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_disptarjetasequipos WHERE idevento = $idevento ");
$filasp019_7=mysql_num_rows($resultado);
////////////////////////
$resultado = mysql_query("SELECT * FROM p019_relevamientoserviciomovil WHERE idevento = $idevento ");
$filasp019_8=mysql_num_rows($resultado);
////////////////////////
